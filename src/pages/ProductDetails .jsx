...
<section className='mb-35'>
  <Container>
      ...
      <span className='text-black/50'> <Link to="">Gaming</Link> </span>
      <span className='ml-2 mr-2 text-black/50 text-xs'>/</span>
...
<div className='w-50 h-full flex flex-col justify-between'>
  ...
  <div className='w-full h-35.5 bg-[#F5F5F5] rounded cursor-pointer flex justify-center items-center'>
    <Image className="w-full h-full"  src={PDimg3}/>
  </div>

    <div className='w-full h-35.5 bg-[#F5F5F5] rounded cursor-pointer flex justify-center items-center'>
    <Image className="w-full h-full"  src={PDimg4}/>
  </div>

<div className='w-full h-35.5 bg-[#F5F5F5] rounded cursor-pointer flex justify-center items-center'>
    <Image className="w-full h-full"  src={PDimg5}/>
  </div>
</div>
<div className='w-142.5 h-full bg-[#F5F5F5] rounded flex justify-center items-center cursor-pointer'>
  <Image className="w-full h-full" src={PDimg1}/>
</div>
      </div>
      </div>
      <div className='w-4/12 '>
      <p className='font-inter font-semibold text-2xl text-black'>Havic HV G-92 Gamepad</p>
      ...
      <p className='font-inter  font-normal text-2xl text-black'>$192.00</p>

      <p className='font-pop  font-normal text-sm text-black w-93.25 mt-6 pb-6 border-b border-b-black/50 mb-6'>PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive.</p>
...
<span className='font-pop font-medium text-xl text-black'>2</span>
</div>
